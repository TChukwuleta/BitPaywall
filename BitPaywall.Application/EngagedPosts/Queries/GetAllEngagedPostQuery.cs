...
namespace BitPaywall.Application.EngagedPosts.Queries
{
    ...
    public class GetAllEngagedPostQueryHandler : IRequestHandler<GetAllEngagedPostQuery, Result>
    {
        private readonly IAppDbContext _context;
        private readonly IAuthService _authService;

        public GetAllEngagedPostQueryHandler(IAppDbContext context, IAuthService authService)
        {
            _context = context;
            _authService = authService;
        }

        public async Task<Result> Handle(GetAllEngagedPostQuery request, CancellationToken cancellationToken)
        {
            try
            {
